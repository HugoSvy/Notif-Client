const publicVapidKey =
  "BCZIuU20aeT9BB6zwh7f63v8w4V5-W6qvEvWoFBCMa3sDt1VFnXYyEsr7DEeQsjGWgg20Jhgowdf5cpYIWaqcpA";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator && "PushManager" in window) {
    try {
      ...
      await fetch("https://tolerant-namely-swift.ngrok-free.app/subscribe", {
        method: "POST",
      ...
      console.error(
        "Erreur lors de l'enregistrement du service worker ou de l'abonnement :",
        err
      );
    }
  } else {
